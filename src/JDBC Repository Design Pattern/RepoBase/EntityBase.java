...
/**
 * RepoBase.EntityBase is the base class for all objects in the application <br/>
...
public abstract class EntityBase implements Comparable<Object>
{
     ...
     * @return the instance of RepoBase.EntityBase with the ID set.  This allows chaining the setID(#) method call
     */
