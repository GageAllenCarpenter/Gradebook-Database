...
/**
 * RepoBase.RepoBase is a base class implementing common RepoBase.Repository API methods that don't require something
...
public abstract class RepoBase<T extends EntityBase>
{
     ...
     *   the specific class's add method as defined in the RepoBase.Repository interface
     ...
     *   This is accomplished by looping over each record and calling
     *   the specific class's update method as defined in the RepoBase.Repository interface
     ...
     *   This is accomplished by looping over each record and calling
     *   the specific class's delete method as defined in the RepoBase.Repository interface
